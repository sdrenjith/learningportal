                ...
                <div class="card-content">
                            ...
                            <div>
                                ...
                                <select wire:model="question_type_id" class="modern-select" id="question_type_id">
                                    ...
                                    @foreach($questionTypes as $type)
                                        <option value="{{ $type->name === 'statement_match' ? 'statement_match' : ($type->name === 'opinion' ? 'opinion' : ($type->name === 'mcq_multiple' ? 'mcq_multiple' : ($type->name === 'reorder' ? 'reorder' : ($type->name === 'form_fill' ? 'form_fill' : $type->id)))) }}">{{ ucfirst(str_replace('_', ' ', $type->name)) }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div x-data="{ type: $wire.entangle('question_type_id') }">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="form-fill-paragraph-section">
                                    ...
                                    <textarea wire:model.live.debounce.100ms="form_fill_paragraph" rows="6" 
                                              ...
                                              class="modern-textarea">{{ $record->form_fill_paragraph }}</textarea>
                                    ...
                                    @if(trim($form_fill_paragraph ?? ''))
                                        <div class="paragraph-info">
                                            ...
                                            <span>Contains {{ substr_count($form_fill_paragraph, '___') }} blank(s) to fill.</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="section-block" id="reorder-section" x-show="type === 'reorder'">
                            ...
                            <!-- Preview Section -->
                            @if(count($reorder_fragments) > 0 && trim($reorder_answer_key ?? ''))
                                <div class="mb-6">
                                    <h4 class="sub-question-title mb-4">Preview</h4>
                                    <div class="preview-section">
                                    ...
                                    <div class="true-false-item" wire:key="tf_question_{{ $tfIndex }}">
                                        ...
                                        <div class="true-false-content">
                                            <div class="mb-4">
                                                ...
                                                <textarea wire:model.live.debounce.300ms="true_false_questions.{{ $tfIndex }}.text" 
                                                          rows="3" placeholder="Enter the statement text..." class="modern-textarea"></textarea>
                                                @error("true_false_questions.{$tfIndex}.text") <p class="error-text">{{ $message }}</p> @enderror
                                            </div>
                                            <div class="mb-4">
                                                <label class="modern-label">Correct Answer</label>
                                                <div class="true-false-options">
                                                    <button type="button"
                                                        class="true-false-option {{ ($true_false_questions[$tfIndex]['correct_answer'] ?? '') === 'true' ? 'selected' : '' }}"
                                                        wire:click="$set('true_false_questions.{{ $tfIndex }}.correct_answer', 'true')">
                                                        <div class="option-circle">
                                                            <svg class="w-5 h-5 checkmark {{ ($true_false_questions[$tfIndex]['correct_answer'] ?? '') === 'true' ? 'show' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <button type="button"
                                                        class="true-false-option {{ ($true_false_questions[$tfIndex]['correct_answer'] ?? '') === 'false' ? 'selected' : '' }}"
                                                        wire:click="$set('true_false_questions.{{ $tfIndex }}.correct_answer', 'false')">
                                                        <div class="option-circle">
                                                            <svg class="w-5 h-5 checkmark {{ ($true_false_questions[$tfIndex]['correct_answer'] ?? '') === 'false' ? 'show' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"></path>
                                                            </svg>
                                                        </div>
                        ...
                        <div class="section-block" id="mcq-multiple-section" x-show="type === 'mcq_multiple'">
                                ...
                                @foreach($sub_questions as $subIndex => $subQuestion)
                                    <div class="sub-question-item" wire:key="sub_question_{{ $subIndex }}">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <textarea wire:model.live.debounce.300ms="sub_questions.{{ $subIndex }}.question" 
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="space-y-3">
                                                @foreach($sub_questions[$subIndex]['options'] as $optIndex => $option)
                                                    <div class="option-item" wire:key="option_{{ $subIndex }}_{{ $optIndex }}">
                                                        <div class="flex items-center space-x-3">
                                                            <div class="option-number">{{ $optIndex + 1 }}</div>
                                                            <div class="flex-1">
                                                                <input type="text" wire:model.live.debounce.300ms="sub_questions.{{ $subIndex }}.options.{{ $optIndex }}" 
                                                                       placeholder="Enter option text..." class="option-input">
                                                                @error("sub_questions.{$subIndex}.options.{$optIndex}") <p class="error-text">{{ $message }}</p> @enderror
                                                            </div>
                                                            <div class="flex items-center space-x-2">
                                                                @if($optIndex === 0)
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="space-y-2">
                                                @foreach($sub_questions[$subIndex]['correct_indices'] as $ansIndex => $correctIndex)
                                                    <div class="index-item" wire:key="correct_index_{{ $subIndex }}_{{ $ansIndex }}">
                                                        <div class="flex items-center justify-between mb-3">
                                                            ...
                                                            <div class="text-sm text-gray-600 bg-green-100 px-3 py-1 rounded-full">
                                                                Points to: "{{ $sub_questions[$subIndex]['options'][$correctIndex] ?? 'Option not found' }}"
                                                            </div>
                                                        </div>
                                                        <input type="number" wire:model.live.debounce.300ms="sub_questions.{{ $subIndex }}.correct_indices.{{ $ansIndex }}" 
                                                               min="0" placeholder="0" class="index-input bg-green-50 border-green-200">
                                                        @error("sub_questions.{$subIndex}.correct_indices.{$ansIndex}") <p class="error-text">{{ $message }}</p> @enderror
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                            ...
                            <!-- Preview Section -->
                            <div class="mb-6" wire:key="mcq-multiple-preview-{{ count($sub_questions) }}">
                                <h4 class="sub-question-title mb-4">Preview</h4>
                                <div class="preview-section">
                                    @foreach($sub_questions as $subIndex => $subQuestion)
                                        <div class="sub-question-item">
                                            <div class="mb-4">
                                                <h5 class="font-semibold mb-2">Sub-question {{ chr(97 + $subIndex) }})</h5>
                                            ...
                                            @if(count($subQuestion['correct_indices'] ?? []) > 0)
                                                <div class="mb-4">
                                                    <p class="preview-label">Correct Answer Indices:</p>
                                                    <div class="space-y-2">
                                                        @foreach($subQuestion['correct_indices'] as $ansIndex => $correctIndex)
                                                            <div class="index-item">
                                                                <div class="flex items-center justify-between mb-3">
                                                                    <label class="option-label">Answer Index {{ $ansIndex + 1 }}</label>
                                                                    <div class="text-sm text-gray-600 bg-green-100 px-3 py-1 rounded-full">
                                                                        Points to: "{{ $subQuestion['options'][$correctIndex] ?? 'Option not found' }}"
                                                                    </div>
                                                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        @foreach($left_options as $idx => $option)
                                            <div class="option-item" wire:key="left_option_{{ $idx }}">
                                                <div class="flex items-center space-x-3">
                                                    <div class="option-number">{{ $idx + 1 }}</div>
                                                    <div class="flex-1">
                                                        <input type="text" wire:model.live.debounce.300ms="left_options.{{ $idx }}" 
                                                               placeholder="Enter left option..." class="option-input">
                                                        @error("left_options.{$idx}") <p class="error-text">{{ $message }}</p> @enderror
                                                    </div>
                                                    <div class="flex items-center space-x-2">
                                                        @if($idx === 0)
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2">
                                        @foreach($right_options as $idx => $option)
                                            <div class="option-item" wire:key="right_option_{{ $idx }}">
                                                <div class="flex items-center space-x-3">
                                                    <div class="option-number">{{ $idx + 1 }}</div>
                                                    <div class="flex-1">
                                                        <input type="text" wire:model.live.debounce.300ms="right_options.{{ $idx }}" 
                                                               placeholder="Enter right option..." class="option-input">
                                                        @error("right_options.{$idx}") <p class="error-text">{{ $message }}</p> @enderror
                                                    </div>
                                                    <div class="flex items-center space-x-2">
                                                        @if($idx === 0)
                                    ...
                                    <div class="option-item" wire:key="pair-{{ $pairIdx }}">
                                        ...
                                        <div class="space-y-3">
                                            <div>
                                                ...
                                                @error("correct_pairs.{$pairIdx}.left") <p class="error-text">{{ $message }}</p> @enderror
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                @error("correct_pairs.{$pairIdx}.right") <p class="error-text">{{ $message }}</p> @enderror
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        <!-- Preview Section -->
                        <div class="mb-6" wire:key="opinion-preview-{{ $opinion_answer }}" x-show="type === 'opinion'">
                            <h4 class="sub-question-title mb-4">Preview</h4>
                            <div class="preview-section">
                                <div class="space-y-4">
                                    <div>
                        ...
                        <div class="section-block" x-show="type === 'true_false'">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="true-false-options single">
                                    <button type="button"
                                        class="true-false-option single {{ $true_false_answer === 'true' ? 'selected' : '' }}"
                                    ...
                                    <button type="button"
                                        class="true-false-option single {{ $true_false_answer === 'false' ? 'selected' : '' }}"
